  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="text-[13px] text-white/50 leading-relaxed whitespace-pre-line mb-4">{brief.summary}</p>
        {brief.thesis && (
          <div className="mb-4 rounded-xl border border-white/6 bg-white/[0.03] p-3">
            ...
            <p className="text-[13px] text-white/75 leading-relaxed whitespace-pre-line">{brief.thesis}</p>
          </div>
        )}
        {hasRichSections && (
          <div className="grid gap-3 md:grid-cols-2 mb-4">
            {brief.marketOverview && (
              <div className="rounded-xl border border-white/6 bg-white/[0.03] p-3">
                ...
                <p className="text-[12px] text-white/60 leading-relaxed whitespace-pre-line">{brief.marketOverview}</p>
              </div>
            )}
            {brief.macroContext && (
              <div className="rounded-xl border border-white/6 bg-white/[0.03] p-3">
                ...
                <p className="text-[12px] text-white/60 leading-relaxed whitespace-pre-line">{brief.macroContext}</p>
              </div>
            )}
            {brief.newsSynthesis && (
              <div className="rounded-xl border border-white/6 bg-white/[0.03] p-3 md:col-span-2">
                ...
                <p className="text-[12px] text-white/60 leading-relaxed whitespace-pre-line">{brief.newsSynthesis}</p>
              </div>
            )}
          </div>
        )}
              ...
              <div className="rounded-xl border border-white/6 bg-white/[0.03] p-3">
                ...
                <ul className="space-y-2">
                  {brief.risks.map((risk, index) => (
                    <li key={index} className="text-[12px] text-white/60 leading-relaxed flex gap-2">
      ...
      <motion.div variants={fadeIn} className="glass-card p-5 border-[#E6B84F]/10">
        ...
        <div className="bg-white/[0.02] rounded-xl p-3 mb-3">
          <p className="text-[13px] text-white/60 italic leading-relaxed">
            &ldquo;Hôm nay nhớ ghi chi tiêu nha, đừng để cuối tháng hỏi tiền đi đâu! Level 🐣 Vẹt Con rồi mà còn lười hả? 🦜&rdquo;
          </p>
        </div>
    ...
    const fetchMorningBrief = async () => {
      ...
      try {
        ...
        setAiBrief({
          ...
          marketOverview: typeof data.marketOverview === "string" ? data.marketOverview : undefined,
          macroContext: typeof data.macroContext === "string" ? data.macroContext : undefined,
          newsSynthesis: typeof data.newsSynthesis === "string" ? data.newsSynthesis : undefined,
          risks: Array.isArray(data.risks) ? data.risks.filter((item: unknown) => typeof item === "string") : undefined,
          actionItems: Array.isArray(data.actionItems) ? data.actionItems.filter((item: unknown) => typeof item === "string") : undefined,
        });
      } catch {
