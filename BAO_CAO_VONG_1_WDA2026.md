...
| Thiếu kiểm soát chi tiêu         | **Quỹ Chi tiêu**                   | Chia "lọ" ngân sách kiểu MoMo                 |
...
| **Quỹ Chi tiêu**        | Vấn đề 5.1     | ⭐ Chia "lọ" ngân sách thông minh       |
...
| ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------ | -------------- |
| 🟢**Bước 1: Quản lý chi tiêu** — "Tiền đi đâu hết?"                      | Muốn thoát nợ & đầu tư, phải kiểm soát chi tiêu trước                    | Quỹ Chi tiêu (chia "lọ"), Personal CPI                                | Hàng ngày    |
...
**Bước 1 — Quỹ Chi tiêu** (mapping Vấn đề 5.1): User chia thu nhập vào các "lọ" (ăn uống, nhà ở, giải trí, tiết kiệm...) như MoMo. Personal CPI cho thấy lạm phát thực tác động đến từng lọ.
...
6. **Quỹ Chi tiêu + Quỹ Nợ** — Chia "lọ" ngân sách kiểu MoMo + Công cụ thoát nợ đa dạng.
...
| FR07 | Quỹ Chi tiêu | Chia thu nhập vào các "lọ"            | **C**   | Ăn uống, nhà ở, giải trí, tiết kiệm...  |
...
### 7.3. Quỹ Chi tiêu (/dashboard/budget) — **MỚI, "lọ" ngân sách kiểu MoMo**

- **Chia "lọ"**: User nhập thu nhập → chia vào các lọ (ăn uống, nhà ở, đi lại, giải trí, tiết kiệm, đầu tư)
- **Theo dõi chi tiêu**: Nhập chi tiêu hàng ngày, pie chart so với ngân sách
- **Cảnh báo**: Khi vượt lọ → thông báo + AI gợi ý điều chỉnh
- **Kết nối Personal CPI**: Cho thấy lạm phát ảnh hưởng đến từng lọ như thế nào
...
| ------------------------------------------- | --------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| 🔥**Mổ Mode** (Roast)                | Chi vượt lọ, bỏ app ≥2 ngày, quên trả nợ   | *"3 ngày không cho tao ăn, mày muốn tao chết đói hả? Mà tiền mày cũng đang chết đói luôn rồi đấy 🦜"*          |
...
| 🧠**Thâm Mode** (Passive-aggressive) | Sắp vượt lọ, chi tiêu tăng dần               | *"Mua thêm 1 ly trà sữa nữa thôi nha, tao không nói gì đâu. Chắt già mới mua được nhà thôi mà... À mà kệ 🦜"* |
...
```
[User chi vượt lọ ăn uống 150%] → [Vẹt Vàng mổ: "Ăn uống như sắp
...
| Chế độ                                   | Khi nào                                       | Ví dụ                                                                                      |
| ------------------------------------------- | ---------------------------------------------- | -------------------------------------------------------------------------------------------- |
| 🔥**Mổ Mode** (Roast)                | Chi vượt lọ, không mở app 3 ngày         | *"3 ngày không mở app, tiền vẫn bay nha. Giỏi thật đấy 🦜"*                       |
| 💛**Khen Mode** (Hype)                | Tiết kiệm đạt target, trả nợ đúng hạn | *"Tuần này tiết kiệm được 500K, gà mà biết đẻ trứng vàng, giỏi! 🤩"*        |
| 🧠**Thâm Mode** (Passive-aggressive) | Sắp vượt lọ, chi tiêu tăng               | *"Mua thêm 1 ly trà sữa nữa thôi, chắt già mới mua được nhà... À mà kệ 🦜"* |
...
1. **Vấn đề 5.1 (Quản trị nợ):** Quỹ Chi tiêu (“lọ” ngân sách) + Quỹ Nợ (hợp nhất nợ tín dụng, vay nhà, bạn bè, tín dụng đen + lộ trình thoát nợ Snowball/Avalanche)
